   ...
   internal class Program
   {
      static void Main(string[] args)
      {
         ...
         do
         {
            ...
            // Display grid from activePlayer on where the fired
            ...
            {
               //// Swap using a temp variable - old way
      ...
      {
         Console.WriteLine("Welocme to Battleship Lite");
         Console.WriteLine("Created by Iyad Shobaki - Tim Corey Tutorial");
         Console.WriteLine();
      ...
      private static PlayerInfoModel CreatePlayer(string playerTitle)
      {
         ...
         Console.WriteLine($"Player inforrmation for {playerTitle} ");
         // Ask the user for their name - should be in the user interface becuase interacting with the user
         output.UsersName = AskForUsersName();

         // Load up the shot grid - the logic should be in the library
